...
public class PagingApiResponse {
    ...
    public static class PagingApiResponseBuilder {
        ...
        public static PagingApiResponseBuilder aPagingApiResponseBuilder() {
        ...
        public PagingApiResponseBuilder but() {
            return aPagingApiResponseBuilder().withPage(page).withPageSize(pageSize).withTotal(total).withHasMore(hasMore).withData(data);
        }
